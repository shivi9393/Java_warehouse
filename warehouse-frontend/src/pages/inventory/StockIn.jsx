...
import { ArrowLeft, Save, ArrowDownRight } from 'lucide-react';
        ...
        const fetchData = async () => {
            try {
                const [warehousesData, productsData] = await Promise.all([
                    getWarehouses(), // Assuming optional orgId handled in API client or default
                    getProducts()
                ]);
            ...
            <Card>
                <div className="p-6 border-b border-slate-100 bg-slate-50/50">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 className="text-lg font-medium text-slate-900">Receive Stock</h3>
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                        ...
                        <div className="pt-4 flex items-center justify-end space-x-3 border-t border-slate-100 mt-6">
                            ...
                            <Button
                                type="submit"
                                isLoading={loading}
                                className="bg-green-600 hover:bg-green-700 focus:ring-green-500 shadow-green-500/30"
